const EXERCISES = {
  ...
  VISUALIZATION:{
    title: "Visualization",
    shortDescription: `
    This type of meditation invites you to picture something or someone in your mind — we are essentially replacing the breath with a mental image as the object of focus.
    By conjuring a specific visualization, we not only get to observe the mind, but we also get to focus on any physical sensations.
    `,
    emoji: "🖼️"
  },
  MOVEMENT:{
